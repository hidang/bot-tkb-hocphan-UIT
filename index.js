    ...
    body.entry.forEach(function(entry) {
      ...
      if (webhook_event.message) {
        ...
        if (webhook_event.message.text) {
          ...
          {
            sendMessage(webhook_event.message.sender.id, "Đỗ Văn Bot: " + 'Xin Chào');
          }
          else{sendMessage(webhook_event.message.sender.id, "Đỗ Văn Bot: " + "Xin lỗi, câu hỏi của bạn chưa có trong hệ thống, chúng tôi sẽ cập nhật sớm nhất.");}
        }
      }
    });
